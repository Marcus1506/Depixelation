...
if __name__ == '__main__':
    ...
    training_loop(model, data, 1000, torch.optim.Adam, torch.nn.MSELoss(), (0.8, 0.2), 4, stack_with_padding,
                  True, True, True, 4, 42, 'models/SimpleCNN.pt', 'losses/SimpleCNN.jpg')
